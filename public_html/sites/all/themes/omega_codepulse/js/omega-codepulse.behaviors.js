(function ($) {
   ...
   */
  Drupal.theme.prototype.omegaCodepulseExampleButton = function (path, title) {
   ...
   */
  Drupal.behaviors.omegaCodepulseExampleBehavior = {
    attach: function (context, settings) {
      ...
      $('.some-selector', context).once('foo', function () {
        ...
        var $anchor = Drupal.theme('omegaCodepulseExampleButton', settings.myExampleLinkPath, settings.myExampleLinkTitle);
        ...
        attach: function (context, settings) {
            ...
            $(window, context).on('resize load orientationchange', function () {
                if ($(window).width() < 720) {
                    ...
                    $('#block-system-main-menu > ul.menu',context).addClass('first-level-menu');
                ...
                if ($(window).width() >= 720) {
                    ...
                    $('#block-system-main-menu > ul.menu',context).removeClass('first-level-menu');
