...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?php print $GLOBALS['language']->language; ?>" xml:lang="<?php print $GLOBALS['language']->language; ?>">
  ...
  <head>
    <title><?php print t('CSS Browsing'); ?></title>
    <?php print drupal_get_html_head(); ?>
    <?php print drupal_get_css(); ?>
    <?php print drupal_get_js('header'); ?>
    <style media="all" type="text/css">
	  .layerslider-css-page { padding: 20px; }
    </style>
  </head>

  <body class="layerslider-css-page" onload='Drupal.layerslider_get_css();'>
    <div id="layerslider-css-messages"><?php print theme('status_messages'); ?></div>
    <?php print $content; ?>
